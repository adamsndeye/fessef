...
<div class="messaging">
      <div class="inbox_msg">
              ...
              <div class="chat_people">
                <div class="chat_img">
                   <img v-if="allconversation.avatar != null"
                    :src="'/uploads/avatar/' + allconversation.avatar" >
                    <img
                    v-else
                    :src="'/uploads/avatar/avatar.png'"
                ...
                <div class="chat_ib" >
                  <h5>{{allconversation.name}} <span class="badge badge-primary">{{count}}</span></h5>
        ...
        <div class="mesgs">
         <H2>Vos messages s'affichent ici</H2>
        </div>
      </div>
...
<script>
export default {
  props: ["allconversations","getmessages","id","authuserid","count"],
};
</script>
