              ...
              <div class="modal-content">
                ...
                <div class="modal-body mx-3">
                  <div class="md-form mb-4">
                    ...
                    <input type="hidden" :value="this.user_to">
...
export default {
  ...
  mounted: function () {
    this.user_to = this.user[0].id;
  },
  methods: {
    handleSubmit() {
      console.log(this.user[0].id);
      const data = new FormData();
       data.append("user_from", this.userid);
       data.append("user_to", this.user_to);
